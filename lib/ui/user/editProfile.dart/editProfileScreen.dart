                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled: true,
                        hintStyle: regStyle.copyWith(color: Color(0xFFC4C4C4)),labelText: widget.profileModel.data.username,
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        fillColor: Color(0xFFFBFBFB),
                        filled: true,
                        hintStyle: regStyle.copyWith(color: Color(0xFFC4C4C4)),labelText: widget.profileModel.data.mobile ?? 'No Mobile',
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: AppLocalizations.of(context).translate('email'),labelText: widget.profileModel.data.email ?? 'No email',
                        prefixIcon:  Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: SvgPicture.asset(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: DropdownButton<String>(
                            ...
                            hint: Container(
                              child: Text(
                                widget.profileModel.data.gender ?? 'No gender',
                      ...
                      children: [
                        ...
                        Expanded(
                          child: DropdownButton<String>(
                            ...
                            hint: Container(
                              child: Text(
                                widget.profileModel.data.country ?? 'No country',
                                style: regStyle.copyWith(color: Color(0xFFC4C4C4),fontSize: 17),
                              ),
                            ),
                            icon: Icon(
                  ...
                  appButton(
                      ...
                      onTap: () {
                        ...
                        _bloc.add(TryEdit((b) => b
                          ...
                          ..gender = widget.profileModel.data.gender
...
print('state.user.user.usernamestate.user.user.username${state.user.user.gender}');
