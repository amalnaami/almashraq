...
import 'package:maktabeh_app/ui/mainScreens/author_bloc/author_state.dart';


class AllAuthorScreen extends StatefulWidget {
  @override
  _AllAuthorScreenState createState() => _AllAuthorScreenState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder(
      ...
      builder: (BuildContext context, AuthorState state) {
        error(state.error);
        return Scaffold(
          appBar: app_bar(AppLocalizations.of(context).translate('All Author'), context),
          body: Stack(
            children: [
              Column(
                children: [
