...
class _$GetAuthor extends GetAuthor {
  factory _$GetAuthor([void Function(GetAuthorBuilder) updates]) =>
      (new GetAuthorBuilder()..update(updates)).build();

  _$GetAuthor._() : super._();

  @override
  GetAuthor rebuild(void Function(GetAuthorBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GetAuthorBuilder toBuilder() => new GetAuthorBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GetAuthor;
  }
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper('GetAuthor').toString();
  }
}

class GetAuthorBuilder implements Builder<GetAuthor, GetAuthorBuilder> {
  _$GetAuthor _$v;

  GetAuthorBuilder();

  @override
  void replace(GetAuthor other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$GetAuthor;
  }

  @override
  void update(void Function(GetAuthorBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$GetAuthor build() {
    final _$result = _$v ?? new _$GetAuthor._();
    replace(_$result);
    return _$result;
  }
}
