...
part of all_review_event;

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$GetReviews extends GetReviews {
  factory _$GetReviews([void Function(GetReviewsBuilder) updates]) =>
      (new GetReviewsBuilder()..update(updates)).build();

  _$GetReviews._() : super._();

  @override
  GetReviews rebuild(void Function(GetReviewsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GetReviewsBuilder toBuilder() => new GetReviewsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GetReviews;
  }
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper('GetReviews').toString();
  }
}

class GetReviewsBuilder implements Builder<GetReviews, GetReviewsBuilder> {
  _$GetReviews _$v;

  GetReviewsBuilder();

  @override
  void replace(GetReviews other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$GetReviews;
  }

  @override
  void update(void Function(GetReviewsBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$GetReviews build() {
    final _$result = _$v ?? new _$GetReviews._();
    replace(_$result);
    return _$result;
  }
}
